<template>
  <el-container>
    <el-header class="flex justify-center p-0 h-[50px]">
      <el-menu mode="horizontal" router :ellipsis="false" class="w-full sm:pl-16 sm:pr-16 md:pl-32 md:pr-32 lg:pl-48 lg:pr-48  xl:pl-64 xl:pr-64 2xl:pl-96 2xl:pr-96">
    ...
    <el-main class="p-0 h-[calc(100vh-100px)]">
      <el-scrollbar>
        <div class="sm:ml-16 sm:mr-16 md:ml-32 md:mr-32 lg:ml-48 lg:mr-48  xl:ml-64 xl:mr-64 2xl:ml-96 2xl:mr-96 me-1 pl-32 pr-32 pt-16 min-h-[calc(100vh-100px)] 2xl:shadow-2xl">
