<template>
  <el-dialog v-model='visible' class='w-screen md:w-[900px]' draggable title='添加代办' @close='cancel'>
    <el-form :model='todoItem'>
      <el-form-item class='md:ml-16 md:mr-16' label='事项' prop='title'>
        <el-autocomplete v-model='todoItem.title' :fetch-suggestions='querySearch' class='w-full'
                         clearable></el-autocomplete>
      </el-form-item>
      <el-form-item class='md:ml-16 md:mr-16' label='描述' prop='description'>
        <el-input v-model='todoItem.description' clearable></el-input>
      </el-form-item>
      <el-form-item class='md:ml-16 md:mr-16' label='持续时间' prop='duration'>
        <el-input v-model='todoItem.duration' clearable></el-input>
      </el-form-item>
      <el-form-item class='md:ml-16 md:mr-16' label='截止日期' prop='deadline'>
        <el-date-picker
...
const tabChange = () => {
  nextTick(() => {
    router.push({path: '/tools/todo', query: {tab: activeTab.value}});
  });
};
